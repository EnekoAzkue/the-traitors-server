...
describe("Cast the Buffer value contained in a JSON object to a non blank spaces string:", () => {
  ...
  describe("When the contained value has non blank spaces between content: ", () => {
    ...
    it("should be 329BB402", () => {
      ...
      //--- ACT && ASSERT ---//
        // El .toThrow() se utiliza de está manera ya que si fuese como los anteriores test no funcinaría
        // ya que el error ya ha ocurrido antes de llegar a expect() haciendo que test falle.
